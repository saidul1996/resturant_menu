...
const form = useForm({
    ...
    discount: props.category.discount
});
                        ...
                        <form @submit.prevent="submit">
                            <div class="mb-6">
                                ...
                                >
                                    ...
                                    <option v-for="category in recursiveCategories(categories)" :key="category.id" :value="category.id" :selected="form.parent_id === category.id">
