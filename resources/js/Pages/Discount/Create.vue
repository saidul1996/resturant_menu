                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <form @submit.prevent="submit">
                            ...
                            <div class="mb-6" v-if="form.discount_type === '2'">
                                <label
                                    for="category_id"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"
                                >Select Category <span class="text-red-500">*</span></label>
                                <select 
                                ...
                                >
                                    ...
                                    <option v-for="category in recursiveCategories(categories)" :key="category.id" :value="category.id">
                                        ...
                                        {{ category.name + ' (' + category.discount + '%)' }}
                                    </option>
                                </select>
                                <div
                            ...
                            <div class="mb-6" v-if="form.discount_type === '3'">
                                <label
                                    for="item_id"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"
                                >Select Item <span class="text-red-500">*</span></label>
                                <select 
